...
HTML = {
    ...
    "index": """<html lang="en"><head>
        ...
        <link href="static/styles/bootstrap.min.css" rel="stylesheet"></head>
        <body><div>Oh good, everything started up right! Add a table name to the end of the URL!</div></body>
        </html>""",
    "selectTable": """<html lang="en"><head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="description" content="hi">
        ...
        </head><body><table class="table table-striped"><thead><tr>"""
}
